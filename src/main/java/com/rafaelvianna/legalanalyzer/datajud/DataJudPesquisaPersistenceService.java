...
public class DataJudPesquisaPersistenceService {
    ...
    public DataJudPesquisaPersistenceService(DataJudPesquisaRepository repository) {
    ...
    public List<DataJudPesquisaEntity> listar() {
        return repository.findTop100ByOrderByCriadoEmDesc();
    }
}
